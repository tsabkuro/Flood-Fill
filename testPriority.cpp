...
TEST_CASE("PriorityNeighbours::insertion_removal_isempty", "[weight=1][part=priority]") {
  ...
  PixelPoint pp5(16, 12, HSLAPixel(30, 0.9, 0.1)); // new
  PixelPoint pp6(50, 12, HSLAPixel(30, 0.9, 0.1)); // new
  PixelPoint pp7(50, 6, HSLAPixel(30, 0.9, 0.1)); // new
  PixelPoint pp8(3, 12, HSLAPixel(30, 0.9, 0.1)); // new

  // get the expected priority order
  expected.push_back(pp1);
  expected.push_back(pp2);
  expected.push_back(pp3);
  expected.push_back(pp7); // new
  expected.push_back(pp8); // new
  expected.push_back(pp4);
  expected.push_back(pp5); // new
  expected.push_back(pp6); // new
